...
dirInCluster = '/panfs/pfs.local/work/crmda/y407w211/kSZ/Cluster/'
dirInSnap = '/panfs/pfs.local/work/crmda/y407w211/kSZ/maps/Zsnap_Box0/'
...
for ii in range(len(snap_array)):
    snap = snap_array[ii]
    f1 = open( dirInCluster + "cluster_new_0"+str(snap)+".dat")
    lines2 = f1.readlines()
    ...
    for fi in range (filenum):
        ...
        fileIn = dirInSnap + "Zsnap_Box0/mymap_box0_s"+str(snap)+"_is256_Zsnap_"+str(fi)+".0"+str(snap)+".a.z.fits"
